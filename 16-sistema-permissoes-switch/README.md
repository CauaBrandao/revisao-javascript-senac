# Exercício 16 — Sistema de permissões

## Objetivo

Utilizar `switch` para retornar permissões diferentes conforme o tipo de usuário.

## Conteúdos praticados

`switch`, `case`, `default`, funções, parâmetros e retorno.
